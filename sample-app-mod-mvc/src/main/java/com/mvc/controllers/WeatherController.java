...
// The generated code is similar to code found in file https://github.com/Sherpa99/appmod-app-modernization/blob/master/src/main/java/com/ibm/ta/modresorts/WeatherServlet.java licensed under apache-2.0
...
@Controller
public class WeatherController implements DisposableBean {
  ...
  @GetMapping("/weather")
  @ResponseBody
  public void getWeatherData(@RequestParam String selectedCity, HttpServletResponse response)
      throws ServletException, IOException {

    String methodName = "getWeatherData";
    logger.entering(WeatherController.class.getName(), methodName);
  ...
  @PostMapping("/weather")
  @ResponseBody
  public void postWeatherData(@RequestParam String selectedCity, HttpServletResponse response)
      throws ServletException, IOException {

    getWeatherData(selectedCity, response);
  }
