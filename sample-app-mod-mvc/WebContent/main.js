...
function callRESTAPI() {
    ...
    if (chosenCity === "Paris"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=Paris", true);
    }
    else if (chosenCity === "Las Vegas"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=Las_Vegas", true);
    }
    else if (chosenCity === "San Francisco"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=San_Francisco", true);
    }
    else if (chosenCity === "Miami"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=Miami", true);
    }
    else if (chosenCity === "Cork"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=Cork", true);
    }
    else if (chosenCity === "Barcelona"){
        request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/weather?selectedCity=Barcelona", true);
    }
...
function callAvailabilityChecker(dateObj, elem) {
    ...
    request.open('GET', getUrl.protocol+ "//" + getUrl.hostname + ":" + getUrl.port + "/resorts/mvc/availability?date="+dateObj.toLocaleDateString("en-US"), true);
